...
export const profile = [
  { icon: <FaRegUser size={17} />, name: "profile", link: "/me" },
  { icon: <BsHandbag size={17} />, name: "my order", link: "/order/me" },
  { icon: <GrFavorite size={17} />, name: "wishlist", link: "/wishlist" },
  { icon: <MdOutlineModeNight size={17} />, name: "Dark" },
  { icon: <BsQuestionDiamond />, name: "help", link: "/help" },
]
export const hero = [
